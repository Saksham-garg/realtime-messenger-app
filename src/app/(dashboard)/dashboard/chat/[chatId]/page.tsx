...
const page = async ({ params }: Props) => {
    ...
    const chatPartnerId = chatId == userId1 ? userId2 : userId1
    ...
    return (
        <div className='flex-1 flex flex-col justify-between h-full max-h-[calc(100vh-6rem)]'>
            ...
            <Messages intialMessages={initialMessages} sessionId={session.user.id} sessionImage={session.user.image} chatPartner={chatPartner} />
